#!/usr/bin/env python3
"""
HAM10000 Skin Lesion Symbolic Feature Discovery Pipeline — v2 (HGB variants, no SMOTE)

Based on v3 pipeline structure, but Step 5 reverts to HGB variants using
sample_weight for class imbalance handling (no SMOTE oversampling).

Key differences from v3:
  - Step 5: 4 HGB methods (hgb_baseline, hgb_sample_weight, hgb_mi, hgb_mi_sw)
    using sample_weight instead of SMOTE
  - Removed imblearn dependency
  - Kept balanced_accuracy as selection metric
  - Steps 0-4, 6 identical to v3
...
Steps:
  ...
  5. Train classifiers (4 HGB variants with sample_weight)
  6. Generate interpretability report

Usage:
    python experiments/run_ham10000_pipeline_v2.py --config configs/ham10000.yaml --start_step 0
"""
