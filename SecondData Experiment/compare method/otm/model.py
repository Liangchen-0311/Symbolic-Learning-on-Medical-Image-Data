"""Optimized Tsetlin Machine (OTM) for HAM10000 Skin Lesion Classification
...
Architecture (following CIFAR103x3ColorThermometerScoring.py):
    Image binarization: Color Thermometer encoding
        ...
        - 24 bits per pixel (preserves color information, important for dermoscopy)
...
Forward (single-stage, no neural backbone):
    input: dermoscopy image -> resize(32, 32)
