...
def step5_train_classifier(config, device):
    ...
    print(f"\n  --- Method 1: LR + ANOVA direct ---", flush=True)
    ...
    for K in K_values:
        ...
        for C in C_values:
            ...
            if cv > best_cv1:
                best_cv1, best_K1, best_C1 = cv, K, C
    print(f"  Best: K={best_K1}, C={best_C1}, cv_acc={best_cv1:.3f}")
    pipe_lr1 = Pipeline([
    ...
    best_pipes['lr_anova'] = pipe_lr1
    cv_accs['lr_anova'] = best_cv1

    print(f"\n  --- Method 2: RandomForest ---", flush=True)
    rf_configs = [(100, 5), (200, 5), (300, 5), (300, 10)]
    rf_K_values = [50, 100, 200, 300]
    ...
    print(f"\n  --- Method 3: SVM (RBF) + ANOVA ---", flush=True)
